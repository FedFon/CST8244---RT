...
const char *outMessage[NUM_OUTPUTS] = {
		...
		"Person has been weighed, weight: ", "The left door has been opened.",
		"The right door has been opened.", "The left door has been closed.",
		...
		"The guard has unlocked the left door.", "Program has exited."
...
typedef struct {
	...
	int person_id;
	int weight;
	int direction;/*0 for nothing, 1 for left scan, 2 for right scan*/
