/*
 *NAME: 		des_inputs.c
 *PURPOSE: des_inputs will be a client to des_controller. Will have a connection with des_controller and will be sending a Person object to des_controller with the values (states) depending on the user input
